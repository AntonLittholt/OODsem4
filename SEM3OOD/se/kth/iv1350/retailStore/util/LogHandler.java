...
/**
 * This class is responsible for the errorlog.
 */
public class LogHandler {
    private static final String LOG_FILE_NAME = "retailStoreError-log.txt";
    private PrintWriter logFile;
    
    /**
     * creates a new logFile
     * @throws IOException when filename is unusable
     */
